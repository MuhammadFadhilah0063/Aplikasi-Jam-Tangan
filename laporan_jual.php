...
$barang_keluar = query("SELECT * FROM barang_keluar ORDER BY id_bk DESC LIMIT $awalData, $jumlahDataPerHalaman");

// tombol cari ditekan
if ( isset($_POST["cari"]) ) {
    $barang_keluar = cari_keluar($_POST["keyword"]);
}
        ...
        <div class="wrapper">
            <div id="tombol">
                    <ul class="tombol-cari-cetak">
                        ...
                        <li>
                            <form action="cetak_keluar.php" method="post" target="_blank">
                                <div class="tmbl_cari">
            ...
            <table class="table1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <!-- Button Hapus -->
                        <span id="hapus"><a href="hapus_laporan_keluar.php?id_bk=<?= $row["id_bk"]; ?>" onclick="return confirm('Yakin?');">Hapus</a></span>
                        <!-- Button Ubah -->
                        <a href="ubah_keluar.php?id_bk=<?= $row["id_bk"]; ?>">Ubah</a>
